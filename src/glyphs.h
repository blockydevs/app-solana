...
extern unsigned int const C_icon_solana_16x16_colors[];
extern unsigned char const C_icon_solana_16x16_bitmap[32];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_icon_solana_16x16;
...
extern unsigned int const C_icon_solana_64x64_colors[];
extern unsigned char const C_icon_solana_64x64_bitmap[512];
#ifdef HAVE_BAGL
        #include "bagl.h"
        extern const bagl_icon_details_t C_icon_solana_64x64;
